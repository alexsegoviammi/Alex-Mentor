...
if (process.env.SUPABASE_URL && process.env.SUPABASE_SERVICE_ROLE_KEY) {
	...
	console.warn(
		"⚠️ Supabase no configurado. El Rate Limiting estará desactivado."
	);
}
...
// Middleware de Rate Limiting (Tu lógica de Supabase adaptada a Express)
